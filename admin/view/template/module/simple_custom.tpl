    ...
    <td>
        <?php if (!empty($field['type'])) { ?>
            <?php if ($field['type'] == 'text' || $field['type'] == 'date' || $field['type'] == 'time' || $field['type'] == 'tel' || $field['type'] == 'phone' || $field['type'] == 'email') { ?>
                <input type="text" name="<?php echo $field['id'] ?>" value="<?php echo $field['value'] ?>" <?php echo $field['type'] == 'date' ? 'class="form-control datepicker"' : 'class="form-control"' ?> <?php echo $field['type'] == 'time' ? 'class="timepicker"' : '' ?>>
            <?php } ?>
