...
$_['cli_error_curl_download'] = 'ERROR: The URL download error: %s Return code: %s';
...
$_['cli_error_unknown_type_catalog'] = 'Unknown type catalog';
$_['error_permission'] = 'Warning: You do not have permission to modify CSV Price Pro import/export!';
$_['error_read_uploaded_file'] = 'Error when reading from uploaded file';
