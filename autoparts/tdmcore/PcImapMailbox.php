...
class ImapMailbox {
	...
	protected function initMailPart(IncomingMail $mail, $partStructure, $partNum) {
		...
		if(!empty($params['charset'])) {
			if(strtoupper($params['charset']) != strtoupper($this->serverEncoding)){
				// PC: I use this for retrieving CSV files from attachments that has been created on Windows.
				// Leave it as is. It works fine without convert shit
